<%@ Page Title="" Language="C#" MasterPageFile="~/PagMaestra.Master" AutoEventWireup="true" CodeBehind="MostrarProducto.aspx.cs" Inherits="ProyectoMulti.Cereales" %>
    ...
    <asp:DataList ID="DataList1" CssClass="grilla" RepeatColumns="3" runat="server" DataKeyField="ProductoId" DataSourceID="SqlDataSource1">
        <ItemTemplate>
            <div class="fondo">
                ...
                <br />
                <a href="Descripcion.aspx?pId=<%#Eval("ProductoId") %>"><span class="button">Ver Producto</span></a>
               </div>
        </ItemTemplate>
    </asp:DataList>
