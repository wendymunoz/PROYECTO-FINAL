...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:FormView ID="FormView1"  DefaultMode="Insert" runat="server" DataKeyNames="ProductoId" DataSourceID="SqlDataSource1" OnItemInserted="FormView1_ItemInserted" BorderColor="#00CC00">
       
        <InsertItemTemplate>
            CategoriaId:
            <asp:TextBox Text='<%# Bind("CategoriaId") %>'  CssClass="textBox" runat="server" ID="CategoriaIdTextBox" /><br />
            Nombre:
            <asp:TextBox Text='<%# Bind("Nombre") %>' CssClass="textBox" runat="server" ID="NombreTextBox" /><br />
            Stock:
            <asp:TextBox Text='<%# Bind("Stock") %>' CssClass="textBox" runat="server" ID="StockTextBox" /><br />
            Precio:
            <asp:TextBox Text='<%# Bind("Precio") %>' CssClass="textBox" runat="server" ID="PrecioTextBox" /><br />
            Imagen:
            <asp:TextBox Text='<%# Bind("Imagen") %>' CssClass="textBox" runat="server" ID="ImagenTextBox" /><br />
            Descripcion:
            <asp:TextBox Text='<%# Bind("Descripcion") %>' CssClass="textBox" runat="server" ID="DescripcionTextBox" /><br />
